...
tags:
  ...
  - 'JS Events'
  - 'Web'
description: 'A pretty loading screen for people to look at while your website loads.'
---
...
give your users a more cohesive visual experience when they enter your site. To do this, We're going to create this
preloader:
...
[GitHub repo](https://github.com/robyn3choi/robyn-portfolio-2019). (If, for some reason, you don't enjoy meticulously
sifting through unfamiliar code to find the parts you need, here are the relevant
...
First, let's write the HTML. Put this block at the top level of your site - you could place it as a direct child of the
